...
\begin{frame}{Discussão dos Resultados}
  \begin{itemize}
    ...
    \item \textbf{Controle Adaptativo da Busca:}
      \begin{itemize}
        \item O decaimento temporal reduz mutações agressivas no fim da execução, concentrando a busca em ajustes finos nos centroides mais promissores.
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Configuração Final Executada}{Parâmetros da Execução Consolidada}
  \begin{block}{Configuração Única --- Mesma para todos os 5 datasets}
    \centering
    \scriptsize
    \begin{tabular}{ll}
      \toprule
...
\begin{frame}{Conclusões}
  \begin{itemize}
    ...
    \item A afinidade por Silhouette manteve o objetivo experimental consistente entre seleção, validação e comparação com o k-Means.
